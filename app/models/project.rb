class Project < ActiveRecord::Base
  ...
  def recommended_users
    ideal_user = User.create(username: "ideal user",
    ...
    interest_list: self.interest_list.join(", "),
    ...
    recommended_users = recommended_users_by_skills + recommended_users_by_interests
